...
<script>
	$(function() {
		...
		$("form").submit(function(e) {
			$("#assetEquityMin").val("0.0");
			$("#assetEquityMax").val("999999999");
		});
		
		//$("#assetEquityMin").val("0.0");
		
		//$("#assetEquityMax").val("0.0");
	});
</script>
<!-- Custom Js(分页用) -->
			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<form action="getFurnitures" method="post">
							<div class="am-g">
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-select-1">单位名称</label> <select id="doc-select-1"
												name="usedDepartment">
									...
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												...
												placeholder="领用人名称" name="recipient">
										</div>
									</div>
									...
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-ipt-text-1">经办人</label> <input
												class="am-u-md-10 form-control" id="doc-ipt-text-1"
												placeholder="经办人名称" name="assetAgent">
										</div>
									</div>
								</div>
										...
										<div class="am-g">
											...
											<div class="am-u-md-10 am-padding-0">
												<input class="am-u-md-12 form-control" id="storageLocation"
													placeholder="存放地点信息" name="storageLocation">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="am-g">
											...
											<div class="am-u-md-10 am-padding-0">
												<input class="am-u-md-12 form-control" id="modelNumber"
													placeholder="型号信息" name="modelNumber">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-ipt-text-2">验收金额</label>
											<div class="am-u-md-10 am-padding-0">
												<input type="text" class="am-u-md-6 form-control" id="assetEquityMin" placeholder="最小金额" name="assetEquityMin">
												<input type="text" class="am-u-md-6 form-control" id="assetEquityMax" placeholder="最大金额" name="assetEquityMax">
											</div>
										</div>
									</div>
								</div>
										...
										<tbody id="tbody-result">
											<c:forEach items="${assetsList }" var="assetItem">
												<tr>
													...
													<td>${assetItem.assetAgent }</td>
													<td>${assetItem.assetLocation.locationName }</td>
													<td>${assetItem.number }</td>
													<td>${assetItem.strStorageTime }</td>
													<td>${assetItem.strStorageTime }</td>
													<td>${assetItem.country }</td>
													<c:if test="${assetItem.certification == true }">
														<td>是</td>
													</c:if>
													<td>${assetItem.number }</td>
												</tr>
