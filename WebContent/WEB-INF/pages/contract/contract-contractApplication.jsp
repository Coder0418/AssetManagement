							...
							<div class="am-g">
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-text-1">合同名称</label> <input
												class="am-u-md-10 form-control" id="doc-ipt-text-1"
												placeholder="输入合同名称" name="contractName">
										</div>
									</div>

									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-phd-1">合同号码</label> 
											<input class="am-u-md-10 form-control" id="applicationNumber"
												name="applicationNumber" placeholder="合同号码">
										</div>
									</div>
									
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-phd-1">支付金额</label> 
											<input class="am-u-md-10 form-control" id="payment" name="payment" placeholder="支付金额">
										</div>
									</div>
									
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-phd-1">对方单位</label> 
											<input class="am-u-md-10 form-control" id="oppositeCompany" name="oppositeCompany" placeholder="对方单位名称">
										</div>
									</div>
								...
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-text-2">合同种类</label>
											<select id="doc-select-1" name="contractCategory.contractCategoryId">
												<option value="">请选择</option>
												<c:forEach items="${contractCategoryList }" var="category">
													<option value="${category.contractCategoryId }">${category.contractCategoryName }</option>
												</c:forEach>
											</select> 
										</div>
									</div>
									...
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-ipt-text-2">申请人</label>
											<div class="am-u-md-10 am-padding-0">
												<input class="am-u-md-12 form-control" id="applicantName"
													placeholder="申请人名称" name="applicantName">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-select-1">申请人部门</label> 
												<select id="doc-select-1" name="applicantCompany">
													<option value="">请选择</option>
