										...
										<tbody id="tbody-result">
											<c:forEach items="${contractList }" var="contract">
												<tr>
													...
													<td>${contract.applicantName }</td>
													<td>${contract.applicantCompany }</td>
													<td>${contract.applyTime }</td>
													<td>${contract.applicationNumber }</td>
													<td>${contract.payment }</td>
													<td>${contract.oppositeCompany }</td>
													<td>${contract.progress }</td>
													<td>${contract.contractCategory.contractCategoryName }</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
