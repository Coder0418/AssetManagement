	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<!-- <li>
				<a href="tab-panel.html"><i class="fa fa-qrcode"></i>
				...
				<li><a href="#"><i class="fa fa-sitemap"></i>资产修改调拨<span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="alterAssetApplication">发送修改申请</a></li>
						<li><a href="alterAssetRevoke">撤销修改申请</a></li>
						<li><a href="getAlterAssetInf">查询修改信息</a></li>
					</ul>
				</li>
			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<form action="alterAssetSubmit" method="post">
							<input type="hidden" name="assetId" value="${assetItem.assetId }" />
							<input type="hidden" name="status" value="${assetItem.status }" />
							<div class="am-g">
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-select-1">单位名称</label> 
											<select id="doc-select-1" name="usedDepartment">
												<option value="${assetItem.department.departmentId }">${assetItem.department.departmentName }</option>
									...
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-ipt-phd-1">资产名称</label>
												<input class="am-u-md-10 form-control" value="${assetItem.assetName }" id="assetName" placeholder="资产名称" name="assetName">
										</div>
									</div>
									
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-phd-1">领用人</label>
											<%-- <input class="am-u-md-10 form-control" value="${assetItem.user.nickName }" id="nickName" placeholder="领用人名称" name="user.nickName"> --%>
											<select id="doc-select-1" name="user.userId">
												<option value="${sessionScope.user.userId }">${sessionScope.user.nickName }</option>
												<c:forEach items="${userList }" var="user">
													<c:if test="${sessionScope.user.nickName != user.userName }">
									...
									<%-- <div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-text-1">经办人</label> 
											<input class="am-u-md-10 form-control" value="${assetItem.assetAgent }" id="assetAgent" placeholder="经办人名称" name="assetAgent">
										</div>
									</div> --%>
								</div>
									...
									<div class="am-form-group">
										<div class="am-g">
											...
											<%-- <div class="am-u-md-10 am-padding-0">
												<input class="am-u-md-12 form-control" id="locationName"
													placeholder="存放地点信息" value="${assetItem.assetLocation.locationName }" name="assetLocation.locationName">
											</div> --%>
											<select id="doc-select-1" name="assetLocation.locationId">
												<option value="${assetItem.assetLocation.locationId }">${assetItem.assetLocation.locationName }</option>
												<c:forEach items="${locationList }" var="location">
													<c:if test="${location.locationName != assetItem.assetLocation.locationName }">
								...
								<div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-ipt-text-2">修改原因</label>
											<div class="am-u-md-10 am-padding-0">
												<input class="am-u-md-12 form-control" id="alterReason"
													placeholder="修改原因" name="alterReason">
											</div>
										</div>
									</div>
								</div>
								...
								<%-- <div class="am-u-md-6">
									<div class="am-form-group">
										<div class="am-g">
											<label class="am-u-md-2 am-md-text-right am-padding-left-0"
												for="doc-ipt-text-2">修改提交人</label>
											<div class="am-u-md-10 am-padding-0">
												<input class="am-u-md-12 form-control" id="alterSubmitUserName"
													placeholder="修改提交人" value="${assetItem.user.nickName }" name="${assetItem.user.userName }">
											</div>
										</div>
									</div>
								</div> --%>
							...
							<br>
							<center><input type="submit" value="提交调拨" class="am-btn am-btn-primary"/></center>
