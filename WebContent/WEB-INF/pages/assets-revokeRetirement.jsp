						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<form action="revokeRetirementSubmit" method="post">
										<input type="submit" value="撤销报废选中项目" class="am-btn am-btn-primary"/>
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody id="tbody-result">
												<c:forEach items="${assetsList }" var="asset">
													<tr>
														<td><input type="checkbox" name="assetItems" id="id[]" value="${asset.assetId }"/>选中/反选</td>
