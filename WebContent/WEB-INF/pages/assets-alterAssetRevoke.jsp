...
<script type="text/javascript">
	...
	$(function() {
        ...
        $("#allAndNotAll").click(function() {
            if (this.checked) {
                $("input[name='extendInfList']:checkbox").each(function() { 
        ...
        $("input[name='extendInfList']:checkbox").click(function() {
        	ids.push($(this).attr("value"));
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">调拨信息</div>
							<div class="panel-body">
								<div class="table-responsive">
									<form action="alterAssetRevokeSubmit" method="post">
										<input type="submit" value="撤销选中调拨信息" class="am-btn am-btn-primary"/>
										<br><br>
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody id="tbody-result">
												<c:forEach items="${alterInfList }" var="extendInf">
													<tr>
														<td><input type="checkbox" name="extendInfList" id="id[]" value="${extendInf.extendId }"/>选中/反选</td>
														<td>${extendInf.assetItem.assetName }</td>
														<td>${extendInf.alterProgress }</td>
														<td>${extendInf.alterReason }</td>
														<td>${extendInf.alterAgentName }</td>
														<td>${extendInf.alterSubmitUserName }</td>
														<td>${extendInf.newLocation.locationName }</td>
														<td>${extendInf.strAlterTime }</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
